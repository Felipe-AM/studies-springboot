...
import io.github.felipe_am.webservices.entities.Payment;
...
import io.github.felipe_am.webservices.repositories.OrderItemRepository;
...
public class TestConfig implements CommandLineRunner{
	...
	public void run(String... args) throws Exception {
		...
		/*
		 * para salvar objetos de classe dependentes em associações 1 p/ 1, utiliza-se
		 * o repositório da classe dominante, conforme feito abaixo
		 */
